...
后续重构又把 generation、prompt/resource、permission review、tool adaptation、interaction projection、
session settings、ACP compatibility 与 compaction/provider-permission coordination 移到 focused owner；
presenter boundary 继续拆分后现为 2,604 行 / 122 methods，并由 3,200 行 architecture guard 约束。
