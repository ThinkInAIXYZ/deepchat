...
| Metric | Value | Status |
| --- | --- | --- |
| `renderer.usePresenter.count` | 90 | baseline |
| `renderer.windowElectron.count` | 111 | baseline |
| `renderer.windowApi.count` | 34 | baseline |
| `hotpath.presenterEdge.count` | 11 | baseline |
