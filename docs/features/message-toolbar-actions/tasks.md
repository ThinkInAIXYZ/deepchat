...
- [x] 创建 `docs/features/message-toolbar-actions/spec.md`
- [x] 创建 `docs/features/message-toolbar-actions/plan.md`
- [x] 创建 `docs/features/message-toolbar-actions/tasks.md`
