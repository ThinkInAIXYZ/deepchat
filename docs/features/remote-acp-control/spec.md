...
This increment builds on [telegram-remote-control](../../archives/telegram-remote-control/spec.md) and [remote-tool-interactions](../remote-tool-interactions/spec.md) without replacing their scope.
