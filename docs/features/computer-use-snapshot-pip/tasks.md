...
Proposal only. All implementation tasks remain open.

## Task List

- [ ] T01 - Propagate Agent run identity through MCP execution
...
- [ ] T02 - Extract the shared process-global PiP coordinator
...
- [ ] T03 - Add source profiles and arbitration
...
- [ ] T04 - Add the narrow Computer Use MCP observer
...
- [ ] T05 - Implement Computer Use target and run state
...
- [ ] T06 - Implement the bounded snapshot pipeline
...
- [ ] T07 - Add typed Computer Use preview contracts
...
- [ ] T08 - Add renderer lifecycle coordination
...
- [ ] T09 - Add the Canvas fallback UI
...
- [ ] T10 - Complete lifecycle and privacy cleanup
...
- [ ] T11 - Add main-process regression coverage
...
- [ ] T12 - Add renderer regression coverage
...
- [ ] T13 - Verify performance budgets
  - Confirm zero additional operating-system captures and zero idle polling.
...
- [ ] T15 - Run repository verification
  - Run `pnpm run format`.
  - Run `pnpm run i18n`.
  - Run `pnpm run lint`.
...
5. T13-T16 measure, validate, and close documentation.

## Done Definition

- A current successful CUA `get_window_state` image can show one latest-snapshot PiP without any
  extra capture or polling.
