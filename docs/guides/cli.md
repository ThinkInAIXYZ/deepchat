...
| 14  | Agent scoped CLI      | bundled `miowork-cli` Skill                                           | main 签发短期、按调用和字节限额的 token，不暴露 human descriptor |
...
| bundled Agent instructions                              | `resources/skills/miowork-cli/SKILL.md`               |
