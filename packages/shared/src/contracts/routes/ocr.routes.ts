import { z } from 'zod'
import { defineRouteContract } from '../common.js'
import { LOCAL_CONTROL_PROTOCOL_VERSION, LOCAL_CONTROL_SURFACE_VERSION } from '../localControl.js'
import {
...
import { ArtifactIdSchema } from './artifacts.routes.js'
