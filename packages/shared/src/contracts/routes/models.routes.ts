import { z } from 'zod'
import { EntityIdSchema, ProviderModelSummarySchema, defineRouteContract } from '../common.js'
import {
...
import { CapabilitySnapshotQuerySchema } from '../../types/model-capabilities.js'
