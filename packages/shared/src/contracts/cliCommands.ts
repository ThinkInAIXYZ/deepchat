import {
  ...
  cliStatusRoute,
  cliVersionRoute
} from './routes/cli.routes.js'
import {
  artifactsDeleteRoute,
  artifactsDescribeRoute,
  artifactsReadRoute
} from './routes/artifacts.routes.js'
import { audioTranscribeArtifactRoute, audioTranscribeUploadRoute } from './routes/audio.routes.js'
import {
...
} from './routes/providers.routes.js'
import {
  eventsSubscribeRoute,
  runsCancelRoute,
  runsGetRoute,
  sessionsRunDetachedRoute
} from './routes/runs.routes.js'
import { settingsGetPublicRoute, settingsUpdatePublicRoute } from './routes/settings.routes.js'
import {
