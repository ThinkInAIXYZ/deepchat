...
} from '../types/core/chat-message.js'
import { createStreamEvent, type ProviderSearchPayload } from '../types/core/llm-events.js'
import type { SearchResult } from '../types/core/search.js'
import type { LLM_PROVIDER } from '../types/provider.js'
...
function parseRequestBody(body: unknown): JsonRecord {
