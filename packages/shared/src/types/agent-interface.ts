import type { ReasoningEffort, ReasoningVisibility, Verbosity } from './model-db.js'
import type { ImageGenerationOptions } from '../imageGenerationSettings.js'
import type { VideoGenerationOptions } from '../videoGenerationSettings.js'
import type { PersistedMcpToolResult, ToolCallImagePreview } from './core/mcp.js'
import type { AgentPlanDisplayItem, AgentPlanTerminalReason } from './agent-plan.js'
import type {
...
import type { OrchestrationPolicy } from '../orchestration/policy.js'
...
export interface DeepChatSubagentMeta {
  ...
  liveDelegation?: import('../orchestration/liveDelegation.js').LiveDelegationSubagentContext
}
...
export interface SessionRecord {
  ...
  toolModeOverride: import('../toolMode.js').ToolModeOverride
  createdAt: number
  updatedAt: number
