...
import { ProviderChange, ProviderBatchUpdate } from '@deepchat/shared/provider-operations'
import { isProviderDbBackedProvider } from '@deepchat/shared/providerDbCatalog'
...
import { ProviderConfig, StreamState } from './types.js'
import { RateLimitManager } from './managers/rateLimitManager.js'
import { ProviderInstanceManager } from './managers/providerInstanceManager.js'
...
export class ProviderRuntimeCore {
  ...
  constructor(
    ...
    this.rateLimitManager = new RateLimitManager(
      providerSettings,
      (id, provider) => this.setProviderById(id, provider),
      publishEvent
    )
