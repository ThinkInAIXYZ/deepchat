...
import { normalizeToolInputSchema } from './aiSdk/toolMapper.js'
import type { ProviderLocalePort } from '@deepchat/shared/provider/locale'
import { buildProviderTraceHeaders, fetchWithProviderHeaders } from './providerHeaders.js'
...
export abstract class BaseLLMProvider {
  ...
  constructor(
    ...
    this.locale = host
    this.defaultHeaders = host.getDefaultHeaders()
      ...
      const toolCalls = functionCallMatches
        .map((match) => {
          ...
          try {
            ...
            // 支持不同格式：
            // 1. { "function_call": { "name": "....js", "arguments": {...} } }
            // 2. { "name": "....js", "arguments": {...} }
            // 3. { "function": { "name": "....js", "arguments": {...} } }
            // 4. { "function_call": { "name": "....js", "arguments": "....js" } }
