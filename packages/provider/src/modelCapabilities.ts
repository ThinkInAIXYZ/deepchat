...
import type { ProviderDbLoader } from './providerDbLoader.js'
import { resolveProviderId as resolveProviderIdAlias } from './providerId.js'
import {
...
export class ModelCapabilities {
  ...
  constructor(private readonly catalog: ProviderDbLoader) {
    this.rebuildIndexFromDb()
    this.unsubscribe = catalog.subscribeCatalogChanges(() => this.rebuildIndexFromDb())
  }
