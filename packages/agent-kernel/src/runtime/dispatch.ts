...
import {
  ...
  QUESTION_TOOL_NAME
} from '../collab/tool/agentTools/questionTool.js'
import { UPDATE_PLAN_TOOL_NAME } from '../collab/tool/agentTools/agentPlanTool.js'
import type {
...
import type { ProgrammaticToolCapabilityV1 } from './programmaticToolSurface.js'
import {
...
} from '../collab/tool/permission/commandPermissionService.js'
import { emitDeepChatLoopNotification } from '../loop/notificationObserver.js'

import { finalizeTrailingPendingNarrativeBlocks } from './accumulator.js'
import type { EchoHandle } from './echo.js'
import {
  insertBlocksAfterToolCall,
  prepareToolImagePreviewPresentation
} from './imageGenerationBlocks.js'
import {
...
import type { ToolImagePreviewPort } from '../contracts/imagePreview.js'
import { selectToolBatchExecutionMode } from './toolExecutionPolicy.js'
import { resolveToolPermissionMode } from '../collab/tool/permission/permissionMode.js'
...
} from './programmaticCommandLaunchError.js'
import {
...
import { recordToolSurfaceCanarySettledToolResult } from './toolSurfaceCanaryDiagnostics.js'
import { prepareProgrammaticExecParent } from './programmaticExecParent.js'
