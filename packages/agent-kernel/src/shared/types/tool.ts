...
import type { DeepChatSubagentCapability, PermissionMode, SessionKind } from './agent-interface.js'
import type { AgentPlanSnapshot } from './agent-plan.js'
import type { DeepChatExecutionContract } from './execution-contract.js'
import type { CommandShellProfile, ResolvedCommandShell } from '../commandShell.js'
