...
import { MAX_TAPE_PROGRAMMATIC_TOOL_INPUT_BYTES } from '@/tape/domain/toolSurfaceFacts'
import type { ProgrammaticToolCapabilityV1 } from '../runtime/programmaticToolSurface'
import type { ToolSurfaceSnapshot } from '../runtime/toolSurface'
import { parseBoundedJsonBytes } from './localControlProtocol'
