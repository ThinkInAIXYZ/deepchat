...
const PLATFORM_SPECIFIC_SERVERS: Record<string, Omit<MCPServerConfig, 'enabled'>> = {
  ...
  ...(isMacOS()
    ? {
        'deepchat/apple-server': {
          args: [],
          descriptions: 'MioWork内置Apple系统集成服务 (仅macOS)',
          icons: '🍎',
  ...
  ...(isWindows()
    ? {
        ...
        //   args: [],
        //   descriptions: 'MioWork built-in Windows system integration service (Windows only)',
        //   icons: '🪟',
        //   type: 'inmemory' as MCPServerType,
  ...
  ...(isLinux()
    ? {
        ...
        //   args: [],
        //   descriptions: 'MioWork built-in Linux system integration service (Linux only)',
        //   icons: '🐧',
        //   type: 'inmemory' as MCPServerType,
...
const DEFAULT_INMEMORY_SERVERS: Record<string, Omit<MCPServerConfig, 'enabled'>> = {
  ...
  Artifacts: {
    args: [],
    descriptions: 'MioWork内置 artifacts mcp服务',
    icons: '🎨',
    type: 'inmemory' as MCPServerType,
    command: 'artifacts',
    env: {},
  ...
  braveSearch: {
    args: [],
    descriptions: 'MioWork内置Brave搜索服务',
    icons: '🦁',
    type: 'inmemory' as MCPServerType,
    command: 'braveSearch',
    env: {
  ...
  difyKnowledge: {
    args: [],
    descriptions: 'MioWork内置Dify知识库检索服务',
    icons: '📚',
    type: 'inmemory' as MCPServerType,
  ...
  ragflowKnowledge: {
    args: [],
    descriptions: 'MioWork内置RAGFlow知识库检索服务',
    icons: '📚',
    type: 'inmemory' as MCPServerType,
  ...
  fastGptKnowledge: {
    args: [],
    descriptions: 'MioWork内置FastGPT知识库检索服务',
    icons: '📚',
    type: 'inmemory' as MCPServerType,
  ...
  'deepchat-inmemory/deep-research-server': {
    args: [],
    descriptions:
      'MioWork内置深度研究服务，使用博查搜索(注意该服务需要较长的上下文模型，请勿在短上下文的模型中使用)',
    icons: '🔬',
    type: 'inmemory' as MCPServerType,
  ...
  'deepchat-inmemory/auto-prompting-server': {
    args: [],
    descriptions: 'MioWork内置自动模板提示词服务',
    icons: '📜',
    type: 'inmemory' as MCPServerType,
  ...
  'deepchat-inmemory/conversation-search-server': {
    args: [],
    descriptions: 'MioWork built-in conversation history search service',
    icons: '🔍',
    type: 'inmemory' as MCPServerType,
