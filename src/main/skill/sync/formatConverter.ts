 ...
 * - serializeToSkillMd: Serialize to MioWork SKILL.md format
...
export class FormatConverter {
  ...
  /**
   * Serialize CanonicalSkill to MioWork SKILL.md format (Claude Code format)
   */
  serializeToSkillMd(skill: CanonicalSkill, options?: Record<string, unknown>): string {
    // MioWork uses Claude Code format as the native format
