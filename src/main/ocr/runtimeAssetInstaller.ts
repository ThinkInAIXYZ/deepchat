...
export class OcrRuntimeAssetInstaller {
  ...
  async install(
    ...
    try {
      return await this.runInstall(asset, target, controller)
    } finally {
  ...
  private async runInstall(
    ...
    try {
      ...
      const extractedDir = this.extractPayload(staged.archivePath, staged.stagingDir)
   ...
   */
  private extractPayload(archivePath: string, stagingDir: string): string {
