...
function buildToolDefinition(
  ...
  return {
    ...
    server: {
      ...
      icons: 'T',
      description: 'MioWork session tape tools'
    }
  }
}
  ...
  getToolDefinitions(): MCPToolDefinition[] {
    return [
      buildToolDefinition(
        ...
        'Search the current MioWork Tape or finalized direct subagent Tapes. Results are compact, source-qualified, and bounded by each linked Tape snapshot.',
        tapeSearchSchema
      ),
      buildToolDefinition(
