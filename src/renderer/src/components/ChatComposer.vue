<template>
  ...
  >
    <TooltipProvider>
      <div :dir="langStore.dir" class="flex flex-col gap-4">
        <div
        ...
        <PromptInput :editor="editor" class="text-base leading-7" @keydown="onKeydown" />
        ...
        <div class="flex flex-wrap items-center justify-between gap-3 pt-2">
          <div class="flex flex-wrap items-center gap-2 text-muted-foreground">
            <Tooltip>
              <TooltipTrigger>
                <IconButton
                  class="h-9 w-9 rounded-lg bg-muted/20 hover:bg-muted/30"
            ...
            <Tooltip>
              <TooltipTrigger>
                <Pill
                  class="search-engine-select flex h-9 items-center gap-1 overflow-hidden rounded-lg bg-muted/10 transition-all duration-300"
                  :class="settings.webSearch ? 'bg-primary/10' : undefined"
                  :dir="langStore.dir"
                >
                  <IconButton
                  ...
                  >
                    <SelectTrigger
                      ...
                      :class="{
                        ...
                        'w-28 max-w-32 px-2 opacity-100':
                          showSearchSettingsButton || isSearchHovering || isSelectOpen
                      }"
                    >
                      <div class="flex items-center gap-1">
                        <SelectValue class="text-xs font-semibold truncate" />
                      </div>
                    </SelectTrigger>
          ...
          <div class="flex items-center gap-3">
            <div
              ...
              :class="[
                currentContextLength / (contextLength ?? 1000) > 0.9
                  ? 'text-destructive'
            ...
            <Button
              variant="default"
              size="icon"
              class="h-10 w-10 rounded-xl text-xs shadow-none"
        ...
        <div v-if="isDragging" class="absolute inset-0 rounded-xl bg-black/40 backdrop-blur-sm">
          <div class="flex h-full flex-col items-center justify-center gap-2">
            <div class="flex items-center gap-1">
              <Icon icon="lucide:file-up" class="h-4 w-4 text-white" />
              <span class="text-sm text-white">{{ t('chat.input.dropFiles') }}</span>
            </div>
            <div class="flex items-center gap-1">
              <Icon icon="lucide:clipboard" class="h-3 w-3 text-white/80" />
