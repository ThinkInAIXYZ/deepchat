...
const Card = defineAsyncComponent(() => import('@shadcn/components/ui/card').then((mod) => mod.Card))
...
const Label = defineAsyncComponent(() => import('@shadcn/components/ui/label').then((mod) => mod.Label))
const ModelIcon = defineAsyncComponent(() => import('@/components/icons/ModelIcon.vue'))
const Input = defineAsyncComponent(() => import('@shadcn/components/ui/input').then((mod) => mod.Input))
