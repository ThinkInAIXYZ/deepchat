...
<template>
  <DialogPortal>
    ...
    <DialogContent
      ...
      :class="cn(
        'fixed z-[60] flex flex-col gap-4 border border-border bg-popover p-6 shadow-xl transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=open]:duration-300 data-[state=closed]:duration-200',
        side === 'right'
