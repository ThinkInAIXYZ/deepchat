...
const packageScriptPattern =
  /^scripts\/(?:afterPack\.js|apple-notarization\.js|build-cua-plugin-runtime\.mjs|compare-light-ocr-package-size\.mjs|install-runtime\.mjs|installVss\.js|notarize(?:-dmg)?\.js|package-plugin\.mjs|plugin\.mjs|sign-cua-helper\.mjs|smoke-(?:duckdb-vss|light-ocr|opendal-native)\.(?:js|mjs))$/
