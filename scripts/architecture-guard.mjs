...
const RETIRED_SETTINGS_MCP_STORAGE_NAMES = new Set([
  'MCPServerConfig',
  'McpSettingsTable',
  'listMcpServers',
  'replaceMcpServers',
...
const RETIRED_MAIN_PATHS = [
  ...
  path.join(ROOT, 'src/shared/types/presenters/window.presenter.d.ts'),
  path.join(ROOT, 'src/shared/types/presenters/acp.presenter.d.ts'),
  path.join(ROOT, 'src/shared/types/presenters/agent-provider.d.ts'),
  path.join(ROOT, 'src/shared/types/presenters/llmprovider.presenter.d.ts'),
  path.join(ROOT, 'src/shared/types/presenters/thread.presenter.d.ts'),
  path.join(ROOT, 'src/shared/types/presenters/core.presenter.d.ts'),
...
const SCHEDULER_ROOT = path.join(ROOT, 'src/main/scheduler')
...
const SESSION_MIGRATED_CONSUMER_PATHS = new Set(
  [
    ...
    'src/main/scheduler/runSessionStarter.ts',
